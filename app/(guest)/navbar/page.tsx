    ...
    <>
      ...
      <nav className="bg-[#543310] py-4 px-6 sm:px-8 md:px-16 lg:px-32 xl:px-48 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a
            href="/register"
            className="bg-[#D6A074] text-white text-sm sm:text-base px-4 py-2 rounded-full"
          >
            sign up
          </a>
        </div>
      ...
      <section className="text-center py-8 sm:py-12">
        ...
        <div className="flex justify-center gap-6 sm:gap-10">
          <div className="w-1/2 sm:w-1/4">
            <Image src="/roundedKopi.svg" alt="Coffee" width={100} height={100} className="rounded-full" />
            <p className="mt-4 text-sm sm:text-base">Lorem Ipsum is simply dummy text...</p>
          </div>
          <div className="w-1/2 sm:w-1/4">
            <Image src="/roundedKopi.svg" alt="Coffee" width={100} height={100} className="rounded-full" />
            <p className="mt-4 text-sm sm:text-base">Lorem Ipsum is simply dummy text...</p>
      ...
      <section className="py-8 sm:py-12 bg-gray-100">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs">
            ...
            <h3 className="mt-4 text-lg font-bold">Coffee Latte</h3>
            <p className="text-sm">Rp139.900</p>
            <p className="text-sm text-gray-500">4rb+ sold</p>
          </div>
          <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs">
