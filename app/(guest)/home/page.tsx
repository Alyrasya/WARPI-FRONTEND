    ...
    <>
      ...
      <nav className="bg-[#543310] py-1 px-6 sm:px-8 md:px-10 lg:px-32 xl:px-8 flex justify-between items-center">
        ...
        >
          <img
            ...
            alt="Logo"
            style={{ width: "64px", height: "55px", marginRight: "4px" }}
          />
          <div
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="bg-[#D6A074] text-white text-base px-3 py-1 rounded hover:bg-[#A67B5B] transition duration-200 outline-none" 
      ...
      <section className="py-8 sm:py-12 bg-gray-100 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Image src="/img/kopi_susu.png" alt="Fun Fact" width={100} height={100} />
