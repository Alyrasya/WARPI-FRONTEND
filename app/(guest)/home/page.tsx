...
const Home = () => {
  ...
  <div className="flex items-center space-x-4">
    ...
    <a
      href="/register"
      className="bg-[#A67B5B] text-white text-sm sm:text-base px-4 py-2 rounded-full hover:bg-[#A67B5B]"
    >
      sign up
    </a>
  </div>
  ...
  <div className="w-full sm:w-1/3 group hover:scale-105 transition-transform duration-300">
    ...
    <div className="relative overflow-hidden rounded-full w-32 h-32 mx-auto mt-4">
      ...
      {/* Fun Fact Section */}
      <section className="py-8 sm:py-12 bg[#fffff] text-center">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">Fun Fact</h2>
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Image src="/kopi.svg" alt="Fun Fact" width={376} height={212} />
  ...
  <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs mx-auto border border-gray-300">
    <Image src="/makanan.svg" alt="Coffee" width={246} height={228} className="rounded-md" />
    <h3 className="mt-4 text-lg font-bold">satay</h3>
    <p className="text-sm">Rp139.900</p>
    <p className="text-sm text-gray-500">4rb+ sold</p>
  </div>
  <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs mx-auto border border-gray-300">
    <Image src="/makanan.svg" alt="Satay" width={246} height={228} className="rounded-md" />
    <h3 className="mt-4 text-lg font-bold">Satay</h3>
    <p className="text-sm">Rp139.900</p>
    <p className="text-sm text-gray-500">4rb+ sold</p>
  </div>
  <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs mx-auto border border-gray-300">
    <Image src="/makanan.svg" alt="Noodles" width={246} height={228} className="rounded-md" />
    <h3 className="mt-4 text-lg font-bold">satay</h3>
    ...
    <p className="text-sm text-gray-500">3rb+ sold</p>
      ...
      <section className="py-8 sm:py-12 bg[#ffff]">
  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 sm:mb-6">Best Coffee & Drink</h2>
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-center">
  <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs mx-auto border border-gray-300">
    <Image src="/templateKopi.svg" alt="Coffee Latte" width={246} height={228} className="rounded-md" />
    <h3 className="mt-4 text-lg font-bold">coffe</h3>
    <p className="text-sm">Rp139.900</p>
    <p className="text-sm text-gray-500">4rb+ sold</p>
  </div>
  <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs mx-auto border border-gray-300">
    <Image src="/templateKopi.svg" alt="Satay" width={246} height={228} className="rounded-md" />
    <h3 className="mt-4 text-lg font-bold">Coffe</h3>
    <p className="text-sm">Rp139.900</p>
    <p className="text-sm text-gray-500">4rb+ sold</p>
  </div>
  <div className="bg-white shadow-lg rounded-lg p-4 max-w-xs mx-auto border border-gray-300">
    <Image src="/templateKopi.svg" alt="Iced Americano" width={246} height={228} className="rounded-md" />
    <h3 className="mt-4 text-lg font-bold">Coffe</h3>
